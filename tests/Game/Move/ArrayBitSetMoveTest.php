...
final class ArrayBitSetMoveTest extends TestCase
{
    public function testToBoard()
    {
        $move = ArrayBitSetMove::fromOffset(5);
    ...
    {
        $board = ArrayBitSetBoard::fromString(7, '1100000101001');
        $moveOffsets = array_map(static function (Move $move) {
            return $move->toOffset();
        }, ArrayBitSetMove::fromBoard($board));
        $expected = [
            0,
            3,
            5,
